...
class MongoDBManagement:
    ...
    def __init__(self, username, password):
        ...
        try:
            ...
            #self.url = "mongodb+srv://{}:{}@cluster0.mt6pq.mongodb.net/myFirstDatabase?retryWrites=true&w=majority".format(self.username, self.password)
            self.url = "mongodb+srv://rakesh:rk123@cluster0.hn7id.mongodb.net/myFirstDatabase?retryWrites=true&w=majority"
